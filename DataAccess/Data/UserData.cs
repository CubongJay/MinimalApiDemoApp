...
public class UserData : IUserData
{
	...
	{
		var results = await _db.LoadData<UserModel, dynamic>("dbo.spUser_GetOne", new { Id = id });

		return results.FirstOrDefault();
	}


	public Task InsertUser(UserModel user) => _db.Savedata("spUser_Insert", new { user.Firstname, user.Lastname });
